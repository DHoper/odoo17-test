...
export class Many2ManyTagsField extends Component {
    ...
    get string() {
        return (
            this.props.string ||
            this.props.record.fields[this.props.name].string ||
            ""
        );
    }
...
export const many2ManyTagsField = {
    ...
    supportedOptions: [
        ...
        },
        {
            ...
            type: "string",
            help: _t(
                "Write a domain to allow the creation of records conditionnally."
            ),
        },
        {
...
registry
    .category("fields")
    .add("form.many2many_tags", many2ManyTagsFieldColorEditable);
